...
?>
  ...
  <body>
    <div class="container-fluid d-flex justify-content-center align-items-center" style="height: 150vh;">
      <div class="card" style="width: 60rem;">
        <div class="card-header text-center fs-1 py-4 " >
          EDIT KARYAWAN
        </div>
        <div class="card-body">
          <form action="proedit_karyawan.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="id_karyawan" autocomplete="off" value="<?php echo $d['id_karyawan']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <?php
                if ($d['foto'] != '') {
                  echo "<img src=\"images/$d[foto] \"width = '100' height = '100'> ";
                } else {
