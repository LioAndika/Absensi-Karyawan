...
<body class="animsition">
    ...
    <script>
        function updateClock() {
            ...
            var dayOfWeek = now.toLocaleDateString('ID', {
                weekday: 'long'
            });
            var day = now.getDate();
            var month = now.toLocaleDateString('ID', {
                month: 'long'
            });
            ...
            var timeString = dayOfWeek + ', ' + day + ' ' + month + ' ' + year + ' ' + formatTime(hours) + ':' + formatTime(minutes);
